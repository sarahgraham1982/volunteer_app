...
MongoClient.connect("mongodb://localhost:27017", { useUnifiedTopology: true })
  .then((client) => {
    ...
    Promise.all([rewardsUsersPromise, charityPromise])
      .then((data) => {
        const [userData, charityData] = data;
        const [user1, user2, user3, user4] = Object.values(userData.ops);
        const [rosendael, bhf, scottishBookTrust, volunteerEdinburgh] =
          Object.values(charityData.ops);
        ...
        return activitiesCollection.insertMany([
          activity1,
          activity2,
          activity3,
          activity4,
